...
(function(global, factory) {
  ...
  var utils = createCommonjsModule(function(module, exports) {
    ...
    var e2ten = (exports.e2ten = function(num) {
      ...
      if (e > 0) {
        ...
        _zs =
          _zs.length < e ? _zs + new Array(e - _zs.length + 1).join("0") : _zs;
        xs = xs.substr(e);
        zs += _zs;
      } else {
        e = -e;
        ...
        _xs =
          _xs.length < e ? new Array(e - _xs.length + 1).join("0") + _xs : _xs;
     ...
     * @returns array
     */
    exports.centerArray = function centerArray(
      baseArray,
  ...
  function toMoney(num, options) {
    ...
    if (options.complete) {
      for (var i = 1; i < this.m_u.length; i++) {
        xs_str +=
          CL.call(this, _decimal.charAt(i - 1) || "0") + this.m_u.charAt(i);
      }
      ...
      if (_decimal) {
        ...
        for (var i = 0; i < this.m_u.length - 1; i++) {
          if (_decimal.charAt(i) && _decimal.charAt(i) != "0") {
            xs_str +=
              CL.call(this, _decimal.charAt(i)) + this.m_u.charAt(i + 1);
            mark_0 = false;
          }
  ...
  var Nzh = function(lang) {
    ...
    this.encode = function() {
      return src.CL.apply(lang, arguments);
    };
    this.decode = function() {
      return src.unCL.apply(lang, arguments);
    };
    this.toMoney = function() {
      return src.toMoney.apply(lang, arguments);
    };
  };
  Nzh.langs = langs;
