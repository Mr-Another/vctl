<template>
  <div :class="treepickerCls" :disabled="disabled">
    <div class="blue-treepicker-show" :class="showCls">
      <template v-if="multiple&&objects.length">
        <div v-if="showCount" class="blue-treepicker-value-single">
          {{'h.treepicker.selectDesc' |
          hlang([valuebak.length])}}
        </div>
        <div v-else class="blue-treepicker-multiple-tags">
      ...
      <div
        ...
        class="blue-treepicker-value-single"
      >{{object[param.titleName]}}</div>
      <div
        v-else
        class="blue-treepicker-placeholder"
      >{{'h.treepicker.placeholder' | hlang(null, placeholder)}}</div>
      <i class="blue-icon-down icon-down"></i>
    </div>
    <div class="blue-treepicker-group" :class="groupCls">
      <div class="blue-treepicker-body">
        <Tree
          ref="tree"
      ...
      <div class="blue-treepicker-footer" v-if="multiple">
        <button
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      let el = (this.el = this.$el.querySelector(
        `.${prefix}>.blue-treepicker-show`
      ));
      let content = this.$el.querySelector(`.blue-treepicker-group`);
