<template>
  <div class="blue-carousel">
    <div class="blue-carousel-container" :style="{height: `${height}px`}">
      <div
        class="blue-carousel-list blue-carousel-scroll-list"
      ...
      >
        ...
        >
          <div
            ...
            class="blue-carousel-bg"
            :class="{'blue-carousel-bg-pointer': params.link}"
      ...
      <div
        class="blue-carousel-list"
        @mouseover="stopAutoplay"
        @mouseout="startAutoplay"
        :key="effect"
        v-else
      >
        <transition :name="`blue-carousel-effect-${effect}`">
          <div
            class="blue-carousel-item blue-carousel-effect-item"
            :key="activeIndex"
          ...
          >
            <div
              v-if="!$scopedSlots.item"
              class="blue-carousel-bg"
              :class="{'blue-carousel-bg-pointer': carouselItem.link}"
    ...
    <ul class="blue-carousel-pagination" :class="paginationCls">
      <li
        class="blue-carousel-pagination-item"
...
export default {
  ...
  computed: {
    ...
    paginationCls() {
      return `blue-carousel-pagination-${this.pageTheme}`;
    },
    arrowCls() {
      return `blue-carousel-arrow-${this.arrow}`;
    }
  },
  watch: {
    autoplay() {
  ...
  methods: {
    ...
    scroll(index, immediately) {
      ...
      switch (this.effect) {
        case "scroll":
          let listDom = this.$el.querySelector(".blue-carousel-scroll-list");
          if (immediately) {
