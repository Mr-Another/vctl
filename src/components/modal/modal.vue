<template>
  <div>
    <div :class="noticeCls">
      <div class="blue-notify-mask" v-if="hasMask" @click="setvalue(true)"></div>
      <div class="blue-notify-body" @click.self="setvalue(true)">
        <transition :name="type">
          <div :class="containerCls" v-if="isShow">
            <span class="blue-notify-close icon-close" v-if="hasCloseIcon" @click="setvalue(false)"></span>
            <header class="blue-modal-header" v-if="hasHeader">
              <slot name="header"></slot>
            </header>
            <div :class="contentCls">
              <slot></slot>
            </div>
            <footer class="blue-modal-footer" v-if="hasFooter">
...
const prefix = "blue-modal";
const notifyprefix = "blue-notify";
