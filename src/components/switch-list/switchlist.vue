<template>
  <div class="blue-switchlist" :class="{'blue-switchlist-small':small}" :disabled="disabled">
    <span
  ...
  computed: {
    arr() {
      if (!this.datas && !this.dict) {
        console.error(
          "[BlueUI Error] Switchlist Component: Datas or dict parameters need to be defined at least."
        );
        return [];
      }
