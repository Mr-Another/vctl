<template>
  <div>
    <div :class="noticeCls">
      ...
      <div :class="{'blue-notify-body': !!hasMask}" @click.self="setvalue(true)">
        <div :class="containerCls">
          <span class="blue-notify-close icon-close" @click="setvalue(false)"></span>
          <component
            :is="nowComponent"
            :class="contentCls"
            :param="propsData"
  ...
  computed: {
    ...
    noticeCls() {
      return {
        ...
        // 'blue-dropdown-common-container': true
      };
    }
  }
};
