    ...
    <div class="page-body universe">
      <div class="part">
        ...
        <p>
          ...
          <Button text-color="primary" size="l" circle @click="goGithub" icon="icon-github">Github</Button>
          <iframe
            class="github-icon"
            src="https://ghbtns.com/github-btn.html?user=blueui&repo=blueui&type=star&count=true&size=large"
            frameborder="0"
          ></iframe>
        </p>
      </div>
...
export default {
  ...
  methods: {
    ...
    goGithub() {
      window.open("https://github.com/blueui/blueui");
    }
  },
  created() {
    this.$nextTick(() => {
